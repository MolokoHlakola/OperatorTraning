/// BareSpecifier=lit-html/async-directive
/**
 * @license
 ...
 */
import { Directive } from './directive.js?version=4d367c6d';
import { AttributePart as LegacyAttributePart, BooleanAttributePart as LegacyBooleanAttributePart, EventPart as LegacyEventPart, NodePart as LegacyNodePart, PropertyPart as LegacyPropertyPart } from './lit-html.js?version=4d367c6d';
/**
...
export class AsyncDirective extends Directive {
    ...
    _legacyGetNode() {
        if (this._legacyPart instanceof LegacyNodePart) {
            ...
            return this._legacyPart.element;
        } else if (this._legacyPart instanceof LegacyPropertyPart || this._legacyPart instanceof LegacyAttributePart) {
