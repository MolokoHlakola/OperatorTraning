import { SakaiElement } from "./sakai-element.js?version=4d367c6d";
import { html } from "./assets/lit-element/lit-element.js?version=4d367c6d";
...
class SakaiSubmissionMessager extends SakaiElement {
  ...
  listRecipients(e) {
    ...
    fetch(`/direct/gbng/listMessageRecipients.json`, { method: "POST", cache: "no-cache", credentials: "same-origin", body: formData }).then(r => r.json()).then(data => {
  ...
  sendMessage(e) {
    ...
    fetch(`/direct/gbng/messageStudents.json`, { method: "POST", cache: "no-cache", credentials: "same-origin", body: formData }).then(r => {
