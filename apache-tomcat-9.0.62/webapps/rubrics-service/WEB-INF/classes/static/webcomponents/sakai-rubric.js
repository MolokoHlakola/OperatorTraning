...
import { SakaiRubricCriteria } from "./sakai-rubric-criteria.js?version=4d367c6d";
import { SakaiRubricCriteriaReadonly } from "./sakai-rubric-criteria-readonly.js?version=4d367c6d";
import { SakaiRubricEdit } from "./sakai-rubric-edit.js?version=4d367c6d";
import { SakaiItemDelete } from "./sakai-item-delete.js?version=4d367c6d";
import { SakaiRubricSiteTitle } from "./sakai-rubric-site-title.js?version=4d367c6d";
import { SakaiRubricModifiedDate } from "./sakai-rubric-modified-date.js?version=4d367c6d";
import { SakaiRubricCreatorName } from "./sakai-rubric-creator-name.js?version=4d367c6d";
import { tr } from "./sakai-rubrics-language.js?version=4d367c6d";
import { SharingChangeEvent } from "./sharing-change-event.js?version=4d367c6d";
    ...
    return html`
      ...
      <div class="collapse-details" role="tabpanel" aria-labelledby="rubric_toggle_${this.rubric.id}" id="collapse_${this.rubric.id}">
        <div class="rubric-details style-scope sakai-rubric">
          ${this.rubric.metadata.locked ? html`<sakai-rubric-criteria-readonly criteria="${JSON.stringify(this.rubric.criterions)}" token="${this.token}"></sakai-rubric-criteria-readonly>` : html`<sakai-rubric-criteria rubric-id="${this.rubric.id}" criteria="${JSON.stringify(this.rubric.criterions)}" token="${this.token}"></sakai-rubric-criteria>`}
        </div>
      </div>
    `;
  }
