...
export class SakaiRubricStudentPreviewButton extends RubricsElement {
  ...
  getRubricId() {
    ...
    SakaiRubricsHelpers.get("/rubrics-service/rest/rubric-associations/search/by-tool-item-ids", this.token, { params: { toolId: this.toolId, itemId: this.entityId } }).then(data => {
